...
<hr>				
	...
	<?php while($rows=mysqli_fetch_array($resultset)){
		...
		$getstd=getAllRecord($con,"pstudentinfo_tb","VenueID ='$assigned_id'","","");
		...
		$getscreened=getAllRecord($con,"recommendation_tb","RegNo LIKE '$regNo'","","");//$getscreened=getAllRecord($con,"recommendation_tb","RegNo LIKE '$regNo' AND final_status=1","","");

		$sc_record=mysqli_num_rows($getscreened);

		/********************************************************************************************/

		$getscreened=getAllRecord($con,"recommendation_tb","RegNo LIKE '$regNo' AND panel_rec=1","","");//$getscreened=getAllRecord($con,"recommendation_tb","RegNo LIKE '$regNo' AND final_status=1","","");

		$no=mysqli_num_rows($getscreened);

		/********************************************************************************************/

		$getscreened=getAllRecord($con,"recommendation_tb","RegNo LIKE '$regNo' AND panel_rec=0","","");//$getscreened=getAllRecord($con,"recommendation_tb","RegNo LIKE '$regNo' AND final_status=1","","");

		$notadm=mysqli_num_rows($getscreened);
	...
	$getscreened=getAllRecord($con,"recommendation_tb","RegNo LIKE '$regNo' AND card !=0","","");//$getscreened=getAllRecord($con,"recommendation_tb","RegNo LIKE '$regNo' AND final_status=1","","");

		$cardno=mysqli_fetch_array($getscreened);

		$cardtotal=array_sum($cardno)
