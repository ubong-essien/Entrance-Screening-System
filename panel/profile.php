...
<div class="container">
  ...
  // $std=GetActiveTime($con,$privilege,$JambNo);// get details based on assigned dept and active slot GetActiveTime($conn,$panelid,$prev,$JambNo)//$assigned_panel
   ...
   // $tbs = "pstudentinfo_tb_ar";
    ...
    $getAll=getAllRecord($con,"pstudentinfo_tb","JambNo='$JambNo'","","");
    ...
    <div class="row" style="height:800px important!;padding-right:10px;padding-left:10px;margin-bottom:100px;margin-right:15px;margin-top:0px;background-color:#efefef;border-radius:3px;">
		...
		<!-- -------------------- Jamb ANALYSIS SECTION----------------- -->
			...
			if($privilege==2){
				...
				<?php
				}else if($screenType == 'DE' && $modeOfEntry == 2){
					//implement diret entry
					?>
            ...
            <div class="card" style="height:880px;overflow-x:scroll;">
                ...
                <div class="card-content" >
						<div class="">
							...
							<?php 
							$AR_ERROR="";
										 if((checkAR($OlevelRstDetails)==true) && (empty($stdInfo['OlevelRst1']))){
						...
						<?php
									...
									}	//SHOW AWAITING RESULT for second sittings
						}
				
							}// end of AR CHECK TO DISPLAY MESSAGE INSTEAD OF ERROR MESSAGES for no result or first sitting
						...
						//		{//if it exist update
							...
							if(($screenType == 'PUTME') && $modeOfEntry == 1){
								...
								if(($waec_adm_status==1) && ($utme_adm_status==0)){
									...
									echo "<li><b style='color:red;display:block;border-radius:2px;background-color:#efefef;font-family:verdana'><li class='fa fa-remove'></li> (".$sys_reason_utme.")</b></li>";//ERROR IN UTME SUBJECTS
								...
								{	
                    									...
                    									if(($screenType == 'PUTME') && ($modeOfEntry == '1')){
                    										...
                    										echo "<h3 style='color:green;font-family:verdana;'>ADMISSIBLE</h3>"; 
                    										$adm_status=1;
                    									}
