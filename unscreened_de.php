...
pstudentinfo_tb_ar
				<div class="row">pstudentinfo_tb_ar
pstudentinfo_tb_arpstudentinfo_tb_ar
				...
				<table width="100%">
						...
						<form action="unscreened_de.php" method="post">
...
//$assigned_id=6;						
			...
			//	echo $assigned_id;
								...
								//	$getstd=getAllRecord($con,"pstudentinfo_tb","ModeOfEntry =2 AND RegLevel=6","ProgID ASC,SurName ASC","");

									//$getstd=Select4rmdbtb($con,"pstudentinfo_tb","",$cond = "VenueID ='$assigned_id ORDER BY SurName ASC'");

                                    $getstd= mysqli_query($con,"SELECT * FROM  pstudentinfo_tb  WHERE JambNo IN(SELECT DISTINCT JambNo FROM pstudentinfo_tb WHERE JambNo NOT IN(SELECT RegNo FROM recommendation_tb)) AND ModeOfEntry=2");
