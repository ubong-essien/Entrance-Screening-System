...
if($dept==-1){
    ...
    $resultset=mysqli_query($con,"SELECT pstudentinfo_tb_ar.FirstName, pstudentinfo_tb_ar.SurName, pstudentinfo_tb_ar.OtherNames,pstudentinfo_tb_ar.JambNo,pstudentinfo_tb_ar.Gender,pstudentinfo_tb_ar.LGA,pstudentinfo_tb_ar.DOB,pstudentinfo_tb_ar.StateId,pstudentinfo_tb_ar.Phone, pstudentinfo_tb_ar.JambAgg,pstudentinfo_tb_ar.JmbComb,pstudentinfo_tb_ar.OtherCert,pstudentinfo_tb_ar.ProgID,recommendation_tb.ModeOfEntry,recommendation_tb.system_reason,recommendation_tb.panel_reason,recommendation_tb.panel_rec,recommendation_tb.medical_rec,recommendation_tb.panel_olvl_def,recommendation_tb.dept,recommendation_tb.final_status 
    FROM recommendation_tb 
    INNER JOIN pstudentinfo_tb_ar 
    on recommendation_tb.RegNo = pstudentinfo_tb_ar.JambNo WHERE recommendation_tb.final_status = {$search_criteria} AND recommendation_tb.ModeOfEntry={$modeofentry} ORDER BY dept ASC,JambAgg DESC");
   ...
   // var_dump($resultset);
    ...
    FROM recommendation_tb 
    INNER JOIN pstudentinfo_tb_ar 
    on recommendation_tb.RegNo = pstudentinfo_tb_ar.JambNo WHERE recommendation_tb.final_status = {$search_criteria} AND recommendation_tb.dept={$dept} AND recommendation_tb.ModeOfEntry={$modeofentry} ORDER BY dept ASC,JambAgg DESC");
...
<div class="wrapper" style="margin-top:70px;margin-left:0px;background-color:#e9e9e9">
				...
				<table width="100%">
						...
						<tr>
						<form action="report_ar.php" method="post">
						<td style="width:5%;">
