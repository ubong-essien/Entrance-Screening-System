...
<div class="container" style="margin-top:70px;">
	<div class="row">
			<div class="col-lg-12">
				...
				<h4 style="text-align:center;font-weight:bold;font-family:san-serif;">LIST OF CANDIDATES FOR <?php echo strtoupper($day)."-".strtoupper($time); ?> SLOT</h4>
				<div class="row">
				...
				<table width="100%">
						...
						<form action="allremark.php" method="post">
						<td style="width:50%;">
