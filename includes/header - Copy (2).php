        ...
        <div class="container" >
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav navbar-right" style="color:orange;">
					...
					<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="">Generate Reports <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
							<li role="presentation"><a href="<?php echo home_base_url();?>report.php">Admission Report</a></li>
                            <li role="presentation"><a href="<?php echo home_base_url();?>resultverification.php">Result Verification</a></li>
                            <li role="presentation"><a href="<?php echo home_base_url();?>attendance.php">Attendance List</a></li>
